...
if (!HAS.call(Validate, 'MIN_ITEMS'))
{
...
if (!HAS.call(Validate, 'MAX_ITEMS'))
{
...
if (!HAS.call(Validate, 'MIN_FILES'))
{
...
if (!HAS.call(Validate, 'MAX_FILES'))
{
...
if (!HAS.call(Validate, 'IP'))
{
    Validate['IP']  = Validate['IPV4'];
}

if (!HAS.call(Validate, 'BIC'))
{
...
if (!HAS.call(Validate, 'CREDITCARDNUMBER'))
{
...
if (!HAS.call(Validate, 'CREDITCARDTYPE'))
{
    Validate['CREDITCARDTYPE'] = function(type) {
        ...
        return Validator(function(v) {
            ...
            if ((validTypes & 0x0040) && /^(2131|1800)/.test(v))
            {
                // Jcb
                return 15 === v.length;
            }
